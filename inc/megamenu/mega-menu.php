...
function start_el( &$output, $item, $depth = 0, $args = array(), $current_object_id = 0 ) {
    ...
    if ( ! empty( $item->_invalid ) ) {
        ...
        $title = sprintf( esc_html__( '%s (Invalid)', 'foldery' ), $item->title );
    } elseif ( isset( $item->post_status ) && 'draft' == $item->post_status ) {
        $classes[] = 'pending';
        /* translators: %s: title of menu item in draft status */
        $title = sprintf( esc_html__('%s (Pending)', 'foldery' ), $item->title );
    }
    ...
    <li data-menuanchor="" id="menu-item-<?php echo ''.$item_id; ?>" class="<?php echo implode(' ', $classes ); ?>">
            ...
            <dt class="menu-item-handle">
                ...
                <span class="item-controls">
                    ...
                    <span class="item-order hide-if-js">
                        ...
                        ?>" class="item-move-up"><abbr title="<?php esc_attr_e('Move up', 'foldery' ); ?>">&#8593;</abbr></a>
                        |
                        <a href="<?php
                            echo wp_nonce_url(
                                add_query_arg(
                        ...
                        ?>" class="item-move-down"><abbr title="<?php esc_attr_e('Move down', 'foldery' ); ?>">&#8595;</abbr></a>
                    </span>
                    <a class="item-edit" id="edit-<?php echo ''.$item_id; ?>" title="<?php esc_attr_e('Edit Menu Item', 'foldery' ); ?>" href="<?php
                        echo ( isset( $_GET['edit-menu-item'] ) && $item_id == $_GET['edit-menu-item'] ) ? admin_url( 'nav-menus.php' ) : add_query_arg( 'edit-menu-item', $item_id, remove_query_arg( $removed_args, admin_url( 'nav-menus.php#menu-item-settings-' . $item_id ) ) );
                    ?>"><?php esc_html_e( 'Edit Menu Item' , 'foldery' ); ?></a>
                </span>
            </dt>
        </dl>
        ...
        <div class="menu-item-settings" id="menu-item-settings-<?php echo ''.$item_id; ?>">
            ...
            <p class="description description-thin">
                <label for="edit-menu-item-title-<?php echo ''.$item_id; ?>">
                    <?php esc_html_e( 'Navigation Label' , 'foldery' ); ?><br />
                    <input type="text" id="edit-menu-item-title-<?php echo ''.$item_id; ?>" class="widefat edit-menu-item-title" name="menu-item-title[<?php echo ''.$item_id; ?>]" value="<?php echo esc_attr( $item->title ); ?>" />
                </label>
            </p>
            <p class="description description-thin">
                <label for="edit-menu-item-attr-title-<?php echo ''.$item_id; ?>">
                    <?php esc_html_e( 'Title Attribute', 'foldery' ); ?><br />
            ...
            <p class="field-link-target description">
                <label for="edit-menu-item-target-<?php echo ''.$item_id; ?>">
                    ...
                    <?php esc_html_e( 'Open link in a new window/tab' , 'foldery' ); ?>
                </label>
            </p>
            <p class="field-css-classes description description-thin">
                <label for="edit-menu-item-classes-<?php echo ''.$item_id; ?>">
                    <?php esc_html_e( 'CSS Classes (optional)' , 'foldery' ); ?><br />
                    <input type="text" id="edit-menu-item-classes-<?php echo ''.$item_id; ?>" class="widefat code edit-menu-item-classes" name="menu-item-classes[<?php echo ''.$item_id; ?>]" value="<?php echo esc_attr( implode(' ', $item->classes ) ); ?>" />
                </label>
            </p>
            <p class="field-xfn description description-thin">
                <label for="edit-menu-item-xfn-<?php echo ''.$item_id; ?>">
                    <?php esc_html_e( 'Link Relationship (XFN)' , 'foldery' ); ?><br />
                    <input type="text" id="edit-menu-item-xfn-<?php echo ''.$item_id; ?>" class="widefat code edit-menu-item-xfn" name="menu-item-xfn[<?php echo ''.$item_id; ?>]" value="<?php echo esc_attr( $item->xfn ); ?>" />
                </label>
            </p>
            <p class="field-description description description-wide">
                <label for="edit-menu-item-description-<?php echo ''.$item_id; ?>">
                    <?php esc_html_e( 'Description' , 'foldery' ); ?><br />
                    ...
                    <span class="description"><?php esc_html_e('The description will be displayed in the menu if the current theme supports it.', 'foldery' ); ?></span>
                </label>
            </p>
            <?php
            /*
            ...
            ?>
            <p class="description description-wide description_width_100">
                <?php echo esc_attr( $title ); ?><br />
                <label for="edit-<?php echo ''.$key . '-' . $item_id; ?>">
                    <select id="edit-<?php echo ''.$key . '-' . $item_id; ?>" class=" <?php echo ''.$key; ?>" name="<?php echo ''.$key . "[" . $item_id . "]"; ?>">
                        <option value="standard" <?php if($value == 'standard' ) echo 'selected="selected"'; ?>><?php esc_html_e( 'Standard Dropdown', 'foldery' ); ?></option>
                        <option value="columns2" <?php if($value == 'columns2' ) echo 'selected="selected"'; ?>><?php esc_html_e( '2 columns dropdown', 'foldery' ); ?></option>
                        <option value="columns3" <?php if($value == 'columns3' ) echo 'selected="selected"'; ?>><?php esc_html_e( '3 columns dropdown', 'foldery' ); ?>
                        </option>
                        <option value="columns4" <?php if($value == 'columns4' ) echo 'selected="selected"'; ?>><?php esc_html_e( '4 columns dropdown', 'foldery' ); ?></option>
                        <option value="columns5" <?php if($value == 'columns5' ) echo 'selected="selected"'; ?>><?php esc_html_e( '5 columns dropdown', 'foldery' ); ?></option>
                    </select>
                </label>
            </p>
            <?php
            $title = 'Sub menu column width ( Default: 250)';
            ...
            <p class="description description-wide obtheme_checkbox obtheme_mega_menu obtheme_mega_menu_d2">
                <label for="edit-<?php echo ''.$key . '-' . $item_id; ?>">
                    <span class='obtheme_long_desc'><?php echo esc_attr( $title ); ?></span><br />
                    <input type="text" value="<?php echo ''.$value; ?>" id="edit-<?php echo ''.$key . '-' . $item_id; ?>" class=" <?php echo ''.$key; ?>" name="<?php echo ''.$key . "[" . $item_id . "]"; ?>" />                   
                </label>
            </p>
            <?php
            ...
            <p class="description description-wide description_width_100">
                ...
                <label for="edit-<?php echo ''.$key . '-' . $item_id; ?>">
                    <select id="edit-<?php echo ''.$key . '-' . $item_id; ?>" class=" <?php echo ''.$key; ?>" name="<?php echo ''.$key . "[" . $item_id . "]"; ?>">
                        <option value="autodrop_submenu" <?php if($value == 'autodrop_submenu' ) echo ' selected="selected" '; ?>><?php esc_html_e( 'Auto drop', 'foldery' ); ?></option>
                        <option value="drop_to_left" <?php if($value == 'drop_to_left' ) echo ' selected="selected" '; ?>><?php esc_html_e( 'Drop To Left Side', 'foldery' ); ?></option>
                        <option value="drop_to_right" <?php if( $value == 'drop_to_right' ) echo ' selected="selected" ' ; ?>><?php esc_html_e( 'Drop To Right Side', 'foldery' ); ?></option>
                        <option value="drop_to_center" <?php if( $value == 'drop_to_center' ) echo ' selected="selected" '; ?>><?php esc_html_e( 'Drop To Center', 'foldery' ); ?></option>
                        <option value="drop_full_width" <?php if( $value == 'drop_full_width' ) echo ' selected="selected" '; ?>><?php esc_html_e( 'Full width', 'foldery' ); ?></option>
                    </select>
                </label>
            </p>
            <?php
            ...
            <p class="description description-wide description_width_100 el_widget_area">
                ...
                <label for="edit-<?php echo ''.$key . '-' . $item_id; ?>">
                    <select id="edit-<?php echo ''.$key . '-' . $item_id; ?>" class=" <?php echo ''.$key; ?>" name="<?php echo ''.$key . "[" . $item_id . "]"; ?>">
                        <option value="" <?php if ( $value == '' ) echo ' selected="selected" '; ?>><?php esc_html_e( 'Select Widget Area', 'foldery' ); ?></option>
                        <?php
            ...
            <p class="description description-wide description_width_100">
                ...
                <label for="edit-<?php echo ''.$key . '-' . $item_id; ?>">
                    <select id="edit-<?php echo ''.$key . '-' . $item_id; ?>" class=" <?php echo ''.$key; ?>" name="<?php echo ''.$key . "[" . $item_id . "]"; ?>">
                        <option value="no_group" <?php if ( $value == 'no_group' ) echo ' selected="selected" '; ?>><?php esc_html_e( 'No', 'foldery' ); ?></option>
                        <option value="group" <?php if ( $value == 'group' ) echo ' selected="selected" ' ; ?>><?php esc_html_e( 'Yes', 'foldery' ); ?></option>
                    </select>
                </label>
            </p>
            <?php
            ...
            <p class="description description-wide description_width_100">
                ...
                <label for="edit-<?php echo ''.$key . '-' . $item_id; ?>">
                    <select id="edit-<?php echo ''.$key . '-' . $item_id; ?>" class=" <?php echo ''.$key; ?>" name="<?php echo ''.$key . "[" . $item_id . "]"; ?>">
                        <option value="0" <?php if ( $value == '0' ) echo ' selected="selected" '; ?>><?php esc_html_e( 'No', 'foldery' ); ?></option>
                        <option value="1" <?php if ( $value == '1' ) echo ' selected="selected" '; ?>><?php esc_html_e( 'Yes', 'foldery' ); ?></option>
                    </select>
                </label>
            </p>
        <?php }
        ...
        <p class="description description-wide obtheme_checkbox obtheme_mega_menu obtheme_mega_menu_d1">
            <label for="edit-<?php echo ''.$key . '-' . $item_id; ?>">
                <?php echo esc_attr( $title ); ?><br />
                <input type="text" value="<?php echo ''.$value; ?>" id="edit-<?php echo ''.$key . '-' . $item_id; ?>" class=" <?php echo ''.$key; ?>" name="<?php echo ''.$key . "[" . $item_id . "]"; ?>" />
                <input alt="#TB_inline?height=400&width=500&inlineId=<?php echo ''.$key . '-' . $item_id . '-popup'; ?>" title="<?php esc_html_e( 'Click to browse icon', 'foldery' ) ?>" class="thickbox button-secondary submit-add-to-menu" type="button" value="<?php esc_html_e( 'Browse Icon', 'foldery' ) ?>" />
            ...
            <p class="description description-wide obtheme_checkbox obtheme_mega_menu obtheme_mega_menu_d2">
                <label for="edit-<?php echo ''.$key . '-' . $item_id; ?>">
                    <span class='obtheme_long_desc'><?php echo esc_attr( $title ); ?></span><br />
                    <input type="text" value="<?php echo ''.$value; ?>" id="edit-<?php echo ''.$key . '-' . $item_id; ?>" class=" <?php echo ''.$key; ?>" name="<?php echo ''.$key . "[" . $item_id . "]"; ?>" />
                    <button id="browse-edit-<?php echo ''.$key . '-' . $item_id; ?>" class="set_custom_images button button-secondary submit-add-to-menu"><?php esc_html_e( 'Browse Image', 'foldery' ); ?></button>
                    <a class="button btn_clear button-primary" href="javascript: void(0);">Clear</a>
                </label>
            </p>
                ...
                <label for="edit-<?php echo ''.$key . '-' . $item_id; ?>">
                    <select id="edit-<?php echo ''.$key . '-' . $item_id; ?>" class=" <?php echo ''.$key; ?>" name="<?php echo ''.$key . "[" . $item_id . "]"; ?>">
                        ...
                        foreach ( $options as $op_value => $op_text ) {
                            ?>
                            <option value="<?php echo ''.$op_value; ?>" <?php if ( $value == $op_value ) echo ' selected="selected" '; ?>><?php echo ''.$op_text; ?></option>
                        <?php
                        }
                        ?>
                    </select>
            ...
            <div class="menu-item-actions description-wide submitbox">
                <?php if( 'custom' != $item->type && $original_title !== false ) : ?>
                    <p class="link-to-original">
                        <?php printf( __('Original: %s', 'foldery' ), '<a href="' . esc_attr( $item->url ) . '">' . esc_html( $original_title ) . '</a>' ); ?>
                    </p>
                <?php endif; ?>
                ...
                ); ?>"><?php esc_html_e('Remove', 'foldery' ); ?></a> <span class="meta-sep"> | </span> <a class="item-cancel submitcancel" id="cancel-<?php echo ''.$item_id; ?>" href="<?php echo esc_url( add_query_arg( array('edit-menu-item' => $item_id, 'cancel' => time()), remove_query_arg( $removed_args, admin_url( 'nav-menus.php' ) ) ) );
                    ?>#menu-item-settings-<?php echo ''.$item_id; ?>"><?php esc_html_e('Cancel', 'foldery' ); ?></a>
            </div>
