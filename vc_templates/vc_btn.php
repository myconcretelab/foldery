...
if ( 'custom' === $style ) {
	$inline_css = vc_get_css_color( 'background-color', $custom_background ) . vc_get_css_color( 'color', $custom_text ) . vc_get_css_color('border-color',$vc_btn_border_color);
	$button_class = ' vc_btn3-shape-' . $shape . ' vc_btn3-style-' . $style . ' ' .$vc_btn_type;
} else {
...
if ( $use_link ):
	?><a class="vc_general <?php echo esc_attr( trim( $button_class ) ); ?>"
