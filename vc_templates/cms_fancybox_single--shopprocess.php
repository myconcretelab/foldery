...
?>
<div class="cms-fancyboxes-wraper cms-fancy-box-single shopprocess <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
    <?php if($atts['title']!=''):?>
        ...
        <div class="cms-fancybox-item">
            ...
            <div class="fancy-box-content-wrap <?php echo esc_attr($cls);?>">
	            <?php if($atts['title_item']):?>
	                <h6><?php echo apply_filters('the_title',$atts['title_item']);?></h6>
	            <?php endif;?>
