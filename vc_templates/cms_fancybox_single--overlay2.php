...
?>
<div class="cms-fancyboxes-wraper cms-fancy-box-single cms-fancybox-single-overlay cms-fancybox-single-overlay2 <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
    <?php if($atts['title']!=''):?>
	            ...
	            <div class="fancy-box-content-wrap no-image row">
		            ...
		            <div class="fancy-box-content">
			            ...
			            <?php if($atts['sub_title_item']):?>
				            <div class="sub-title playfairdisplay"><?php echo apply_filters('the_title',$atts['sub_title_item']);?></div>
				        <?php endif;?>
			            <div class="fancy-box-content-text">
			                <?php echo apply_filters('the_content',$atts['description_item']);?>
			            </div>
			            <?php if($a_href !='' && $a_title!=''):?>
			                <div class="cms-fancyboxes-foot">
