 ...
 */
$title = $source = $type = $onclick = $custom_links = $custom_links_target = $img_size = $external_img_size = $images = $custom_srcs = $el_class = $interval = $css = $cms_item_space = '';
$large_img_src = '';
...
if ( 'nivo' === $type ) {
	...
	$el_start = '<li class="isotope-item" style="margin-left:'.$cms_item_space.'px; margin-bottom:'.$cms_item_space.'px;">';
	$el_end = '</li>';
	$slides_wrap_start = '<ul class="wpb_image_grid_ul" style="margin-left:-'.$cms_item_space.'px;">';
	$slides_wrap_end = '</ul>';
}
