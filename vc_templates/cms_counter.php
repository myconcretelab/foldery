            ...
            for($i=1;$i<=$columns;$i++){ ?>
                <?php if($i!=5):?>
                    ...
                    <div class="<?php echo esc_attr($item_class);?>">
        				...
        				<?php endif; ?>
        				<div id="counter_<?php echo esc_attr($atts['html_id'].'_item_'.$i);?>" class="cms-counter h1 <?php echo esc_attr(strtolower($type));?>" data-suffix="<?php echo esc_attr($suffix);?>" data-prefix="<?php echo esc_attr($prefix);?>" data-type="<?php echo esc_attr(strtolower($type));?>" data-digit="<?php echo esc_attr($digit);?>">
        				</div>
                        <?php if($title):?>
                            <div class="cms-counter-title playfairdisplay"><?php echo apply_filters('the_title',$title);?></div>
                        <?php endif;?>
        			</div>
                <?php endif;?>
            <?php }
